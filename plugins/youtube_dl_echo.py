...
async def echo(bot, update):
    ...
    imog = await update.reply_sticker(sticker="CAACAgEAAx0CUbIxHwACMkVhnkL-QhRI7uV4V1GPRxwa8XzbLgACEwIAAnQfeUTWtBnBNijIhB4E", reply_to_message_id=update.message_id)
